<template>
    <div class="draw-context" id="drawContext" v-show="drawContextDisplay">
       <div id="drawToolbar">
         <el-button class="icon-btn" title="画笔工具" @click="changeCanvasMode('pencel')"><svg-icon icon-class="icon-pencel"/></el-button>
         <el-button class="icon-btn" title="椭圆工具" @click="changeCanvasMode('circle')"><svg-icon icon-class="icon-circle"/></el-button>
         <el-button class="icon-btn" title="矩形工具" @click="changeCanvasMode('rec')"><svg-icon icon-class="icon-rec"/></el-button>
