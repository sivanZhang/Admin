    ...
    <el-tabs type="border-card">
          ...
          <div class="task-board-left" id="task-board-left">
            <div class="tasks-top">
              <div class="list">
                ...
                <svg-icon icon-class="list_min"></svg-icon></span>
                <!--              点击图标显示大型网格布局-->
                <span class="svg-container" title="大型网格布局">
                <svg-icon icon-class="list_max"></svg-icon></span>
                <!--              select选择器，选择项目，默认选择所有-->
                <el-select v-model="value1" multiple placeholder="任何项目" size="mini" collapse-tags
                           style="margin-left: 20px;">
                  <el-option v-for="item in taskList" :key="item.value" :label="item.label" :value="item.value">
                  </el-option>
                </el-select>
                <!--              select选择器，选择任务完成进度，默认选择所有-->
                <el-select v-model="value2" multiple collapse-tags style="margin-left: 20px;" placeholder="任何备注"
                           size="mini">
                  <el-option v-for="item in taskProgress" :key="item.value" :label="item.label" :value="item.value">
                  </el-option>
                </el-select>
              </div>
              <div class="fold-icon">
                <span class="svg-container"><svg-icon icon-class="fold" @click="taskBoardRightShow"></svg-icon></span>
              </div>
            </div>
            <div class="tasks-foot">
              <div class="content-box" v-show="taskAvailableUnFold">
                <div class="task-title">
                  ...
                  <span class="svg-contain"><svg-icon icon-class="eye-open"
                                                      @click="taskAvailableUnFold=!taskAvailableUnFold;taskAvailableFold=!taskAvailableFold"></svg-icon></span>
                </div>
              ...
              <div class="fold-box" v-show="taskAvailableFold">
                ...
                <div style="height: 100px;">
                  <span class="svg-contain"><svg-icon icon-class="eye"
                                                      @click="taskAvailableUnFold=!taskAvailableUnFold;taskAvailableFold=!taskAvailableFold"></svg-icon></span>
                </div>
              </div>
              <div class="content-box" v-show="notStartedUnFold">
                <div class="task-title">
                  ...
                  <span class="svg-contain"><svg-icon icon-class="eye-open"
                                                      @click="notStartedUnFold=!notStartedUnFold;notStartedFold=!notStartedFold"></svg-icon></span>
                </div>
                <div class="sort-order">
                  <span class="sort">排序方式</span>
              ...
              <div class="content-box" v-show="inProgressUnFold">
                <div class="task-title">
                  ...
                  <span class="svg-contain"><svg-icon icon-class="eye-open"
                                                      @click="inProgressUnFold=!inProgressUnFold;inProgressFold=!inProgressFold"></svg-icon></span>
                </div>
                <div class="sort-order">
                  <span class="sort">排序方式</span>
              ...
              <div class="content-box" v-show="doneUnFold">
                <div class="task-title">
                  ...
                  <span class="svg-contain"><svg-icon icon-class="eye-open"
                                                      @click="doneUnFold=!doneUnFold;doneFold=!doneFold"></svg-icon></span>
                </div>
                <div class="sort-order">
                  <span class="sort">排序方式</span>
            ...
            <el-tabs v-model="activeName" @tab-click="handleClick">
              ...
              <el-tab-pane label="动态" name="second">
                <div class="dynamic">
                  ...
                  <el-select v-model="value3" multiple placeholder="任何类型" size="mini" collapse-tags
                             style="margin-left: 20px;">
                    <el-option v-for="item in typeList" :key="item.value" :label="item.label" :value="item.value">
                    </el-option>
                  </el-select>
                  <!--              select选择器，选择时间，默认选择所有-->
                  <el-select v-model="value4" multiple collapse-tags style="margin-left: 20px;" placeholder="任何时间"
                             size="mini">
                    <el-option v-for="item in taskTime" :key="item.value" :label="item.label" :value="item.value">
                    </el-option>
                  </el-select>
                </div>
              </el-tab-pane>
      ...
      <el-tab-pane label="任务列表" style="height: 500px">
        ...
        <div class="task-list-top">
          ...
          <el-select v-model="taskListProgramSel" multiple placeholder="任何项目" size="mini" collapse-tags
                     style="margin-left: 20px;">
            <el-option v-for="item in taskList" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
          </el-select>
          <!--              select选择器，任务列表中选择任务完成进度，默认选择所有-->
          <el-select v-model="taskListProgressSel" multiple collapse-tags style="margin-left: 20px;" placeholder="任何备注"
                     size="mini">
            <el-option v-for="item in taskProgress" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
          </el-select>
      ...
      <el-tab-pane label="时间表" style="height: 500px">
