  ...
  <div>
    ...
    >
      ...
      <el-form-item label="剩余工时">{{
        surplus_labor_hour ? surplus_labor_hour : 0
      }}</el-form-item>
    ...
    <el-row type="flex" justify="end">
      ...
      <el-button :loading="createLoading" type="primary" @click="addRecord()"
        >提交</el-button
      >
    </el-row>
  </div>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        content: [
          { required: true, message: "请输入完成内容", trigger: "blur" },
        ],
        schedule: [
