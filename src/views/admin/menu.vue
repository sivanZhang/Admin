    ...
    <el-tabs tab-position="left" style="height: ;overflow: auto;padding-top:10px">
      <el-tab-pane label="内部时间配置" style="height: auto;overflow: auto;">
        <div style="display:flex">
          <div v-if="$store.state.login.userInfo.auth.admin_management" style="width:40%">
            <div style="display:flex">
              <el-form
                ref="saveForm"
          ...
          <div style="width:60%;">
            <el-table
                ...
                border
              >
                <el-table-column label="上班时间" prop="official_work_on" align="center">
                  <template slot-scope="scope">{{ scope.row.official_work_on?scope.row.official_work_on:"-" }}</template>
                </el-table-column>
                <el-table-column label="下班时间" prop="official_work_off" align="center">
                  <template slot-scope="scope">{{ scope.row.official_work_off?scope.row.official_work_off:"-" }}</template>
                </el-table-column>
                <el-table-column label="工时(小时)" prop="official_work_long" align="center">
        ...
        <div style="display:flex">
          ...
          <div style="width:60%;">
              <el-table
                ...
                border
              >
                <el-table-column label="上班时间" prop="training_work_on" align="center">
                  <template slot-scope="scope">{{ scope.row.training_work_on?scope.row.training_work_on:"-" }}</template>
                </el-table-column>
                <el-table-column label="下班时间" prop="training_work_off" align="center">
                  <template slot-scope="scope">{{ scope.row.training_work_off?scope.row.training_work_off:"-" }}</template>
                </el-table-column>
                <el-table-column label="工时(小时)" prop="training_work_long" align="center">
