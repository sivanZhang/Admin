      ...
      delMarkImage(data, index) {
        ...
        if(this.imgList.length > 0){
            if(bH - (videoInfoH + videoTabsH + 20 + 20 - 82) <= 0){
                ...
                document.getElementById("videoComment").style.height = (bH - (videoInfoH + videoTabsH + 20 + 20 - 82)) + "px";
            }
        }else{
            if(bH - (videoInfoH + videoTabsH + 20 + 20 - 110) <= 0){
                document.getElementById("videoComment").style.height = 0 + "px;"
            }else{
                document.getElementById("videoComment").style.height = (bH - (videoInfoH + videoTabsH + 20 + 20 - 110)) + "px";
            }
        }
      },
      zoomImg(imgUrl) {
